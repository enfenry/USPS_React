import {
    CREATE_APPLICATION_SUCCESSFUL, CREATE_APPLICATION_FAILURE, READ_APPLICATIONS_SUCCESSFUL, READ_APPLICATIONS_PENDING, READ_APPLICATIONS_FAILURE,
...
export default function applicationsReducer(state = {}, action) {
    ...
    switch (action.type) {
        ...
        case CREATE_APPLICATION_SUCCESSFUL: {
            ...
            return { ...state, applications: newApplications, requestState: { ...state.requestState, applicationsCreateSuccess: true, applicationsCreateFailed: false, error: null } };
        }
        case CREATE_APPLICATION_FAILURE:
            return { ...state, applications: state.applications, requestState: { ...state.requestState, applicationsCreateSuccess: false, applicationsCreateFailed: true, error: action.error } };
        ...
        case UPDATE_APPLICATION_SUCCESSFUL: {
            ...
            return { ...state, applications: apps, requestState: { ...state.requestState, applicationsUpdateSuccess: true, applicationsUpdateFailed: false, error: null } };
        }
        case UPDATE_APPLICATION_FAILURE:
            return { ...state, applications: state.applications, requestState: { ...state.requestState, applicationsUpdateSuccess: false, applicationsUpdateFailed: true, error: action.error } };

        case DELETE_APPLICATION_SUCCESSFUL:
            return { ...state, applications: state.applications.filter((e) => e.ss_applicationid !== action.data), requestState: { ...state.requestState, applicationsDeleteSuccess: true, applicationsDeleteFailed: false, error: null } };
        case DELETE_APPLICATION_FAILURE:
            return { ...state, applicationsDeleteSuccess: false, requestState: { ...state.requestState, applicationsDeleteFailed: true, error: action.error } };
