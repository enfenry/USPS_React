...
export default function addressesReducer(state = {}, action) {
    ...
    switch (action.type) {
        case CREATE_ADDRESS_SUCCESSFUL: {
            ...
            return { ...state, addresses: newAddresses, requestState: { addressesCreateSuccess: true, addressesCreateFailed: false, error: null } };
        }
        case CREATE_ADDRESS_FAILURE:
            return { ...state, addresses: state.addresses, requestState: { addressesCreateSuccess: false, addressesCreateFailed: true, error: action.error } };
        ...
        case DELETE_ADDRESS_SUCCESSFUL:
            ...
            return { ...state, addresses: state.addresses.filter((e) => e.ss_customaddressid !== action.data), requestState: { addressesDeleteSuccess: true, addressesDeleteFailed: false, error: null } };
        case DELETE_ADDRESS_FAILURE:
            return { ...state, requestState: { addressesDeleteSuccess: false, addressesDeleteFailed: true, error: action.error } };
